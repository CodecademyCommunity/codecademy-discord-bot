module.exports = {
    ...
    if (arg) {
      ...
      switch(arg) {
        ...
        case "cc!deleteroles":
        case "deleteroles":
          msg.channel.send("Deletes all roles created from Codecademy Discuss. *Admin priviliges required");
          break;

        case "cc!sendcode":
        case "sendcode":
          msg.channel.send("Sends a varification code to your Codecademy Discull email. *requires you to insert your user name after command: cc!sendcode [username]");
          break;
        
        case "cc!verify":
        case "verify":
          msg.channel.send("Verifies that the code entered is valid and gives you a role for every badge you have on Discourse. *requires you to enter your verification code after command: cc!verify [code]");
        ...
        case "cc!stats":
        case "stats":
          msg.channel.send("Displays numbers of online members, offline members, and total members.");
          break;

        default:
          msg.channel.send("That is not a command. For a full list type cc!help");
